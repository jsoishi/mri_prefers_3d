...
\Eeq
The problem is ``generalized" because $M$ is not full rank. The system is 10th order because $L_{1}$ is full rank. We therefore impose the 10 \texttt{boundary conditions} 
\Beq
