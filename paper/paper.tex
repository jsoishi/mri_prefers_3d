...
\Beq
p = \hat{P}(x) e^{ i ( \omega t + k_{z} z + \ell y ) },
\Eeq
...
where
\Beq
   C_{1}(x) &=& \frac{ S \ell  \omega _A^2}{\omega_{S} ( \omega_{S}^2-\omega _A^2 )} \\
   C_{0}(x) &=&  \frac{\frac{f^{2} k_{z}^2 \omega_{S}^{2}}{\omega_{S}^{2}-\omega
   _A^2}+f  S  k_{z}^2 -\frac{2 S^2  k_{y}^2 \omega _A^2}{\omega_{S}^{2}}}{\omega_{S}^2-\omega _A^2}  -\left(k_{z}^2+\ell^2 \right) .
\Eeq
...
\Eeq
The denominator of $\Phi(x)$ cannot vanish if $\omega_{S}=-i \gamma+Sx\ell$, with $Re(\gamma)\neq0$. 
...
\Beq
\Phi(x) \ = \ \frac{\pi^{2}}{d^{2}} + \eps^{2} \frac{B_{0}^2 f^2 \Ro\, \left(k_{z}^2 R+\Ro\, \ell ^2\right) - B_{0}^4 k^4 +f^2 (\Ro+1) (\omega -f\, \Ro\, x\, \ell
   )^2  }{B_{0}^4 k_{z}^2}.
\Eeq
