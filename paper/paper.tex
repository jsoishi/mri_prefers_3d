...
\Eeq
This is the same structure as the asymptotic calculation in the previous section. Now effectively $\Upsilon \propto \gamma_{2}$. The case with dominant 2D modes corresponds to $\gamma_{2}(\s,\x)=0$. Finding this condition is a formidable calculation, which produces the degree-6 polynomial expression  
\Beq
& \y^{6} \s^6\Ro^6  \ + \
