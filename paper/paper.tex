...
\begin{abstract}Ú
The magnetorotational instability (MRI) is a powerful instability where a weak magnetic can destabilize an electrically conducting fluid with a decreasing angular velocity shear.
The MRI is thought to be essential to the operation of astrophysical accretion disks, where the central object supplies a Keplerian angular velocity gradient.
The MRI may also be important in the internal shear layers of stars.
In stellar interiors, the shear can take a wide range to shear profiles, including near-critical, but with negligible dissipative the MRI may operate in a poorly studied regime where the shear is near critical but the dissipative forces are negligible.
