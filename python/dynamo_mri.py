...
problem.add_equation("Dt(vz)             + dz(p) - B*dz(bz) + J*bx + ν*(dx(ωy) - dy(ωx)) = 0")
...
problem.add_equation("Dt(jx) - J*dy(vx) - B*dz(ωx) + S*dz(bx) - η*( dx(jxx) + L(jx) ) = 0")
